...
setclick(!click);
    ...
    return (
        <div className='w-[75%] h-full flex-2 '>
            ...
            <div className=' ml-[20rem] mt-2'><h1 className='text-[1.1rem]'>Already have an account?<span className='hover:text-[#9B6A3B] cursor-pointer'>Login</span></h1></div>
